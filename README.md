...
Note: UI feedback audio (chimes/bells) is retrieved remotely via Mixkit CDN.
Getting Started
Prerequisites
A modern web browser supporting ES6, CSS Touch Events, and the HTML5 Web Audio API.
Execution
